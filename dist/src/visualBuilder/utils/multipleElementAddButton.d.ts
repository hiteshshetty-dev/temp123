 ...
 * @returns void
 */
export declare function handleAddButtonsForMultiple(eventDetails: VisualBuilderCslpEventDetails, elements: {
...
export declare function removeAddInstanceButtons(elements: {
    visualBuilderContainer: HTMLDivElement | null;
 ...
 */
export declare function observeParentAndFocusNewInstance({ parentCslp, index, }: {
    parentCslp: string;
    index: number;
}): void;
//# sourceMappingURL=multipleElementAddButton.d.ts.map