import { IContentTypeRootBlocks, IModularBlockSingleBlock } from "../../../cms/types/contentTypeSchema.types";
export type ISchemaIndividualFieldMap = Record<string, ISchemaFieldMap>;
export type ISchemaFieldMap = (IContentTypeRootBlocks | (IModularBlockSingleBlock & {
    data_type: "block";
    display_name: string;
})) & {
