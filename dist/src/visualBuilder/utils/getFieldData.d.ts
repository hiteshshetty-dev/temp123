 ...
 */
export declare function getFieldData(fieldMetadata: Pick<CslpData, "content_type_uid" | "entry_uid" | "locale">, entryPath?: string): Promise<any>;
//# sourceMappingURL=getFieldData.d.ts.map