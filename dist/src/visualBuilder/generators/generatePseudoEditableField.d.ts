 ...
 */
export declare function isEllipsisActive(element: HTMLElement): boolean;
/**
 ...
 */
export declare function generatePseudoEditableElement(elements: {
    editableElement: HTMLElement;
}, config: {
    textContent: string;
}): HTMLDivElement;
//# sourceMappingURL=generatePseudoEditableField.d.ts.map