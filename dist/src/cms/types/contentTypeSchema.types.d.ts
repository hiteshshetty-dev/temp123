...
export interface ISingleLineTextBoxContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "text";
    field_metadata: {
        description: string;
...
export interface IMultiLineTextBoxContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "text";
    field_metadata: {
        description: string;
        default_value: string;
...
export interface IHTMLRTEContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "text";
    field_metadata: {
...
export interface IJSONRTEContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "json";
    field_metadata: {
        allow_json_rte: true;
        embed_entry: boolean;
...
export interface IMarkdownContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "text";
    field_metadata: {
        description: string;
        markdown: true;
...
export interface ICustomFieldContentTypeSchema extends IContentTypeSchemaCommonData {
...
export interface IBooleanContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "boolean";
    field_metadata: {
        description: string;
...
export interface IReferenceContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "reference";
    reference_to: string[];
    field_metadata: {
...
export interface IExperienceContainerContentTypeSchema extends IContentTypeSchemaCommonData {
...
export interface ITaxanonmyContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "taxonomy";
    field_metadata: {
        description: string;
        default_value: string;
...
export type IContentTypeRootBlocks = ISingleLineTextBoxContentTypeSchema | IMultiLineTextBoxContentTypeSchema | IHTMLRTEContentTypeSchema | IJSONRTEContentTypeSchema | IMarkdownContentTypeSchema | ISelectContentTypeSchema | ICustomFieldContentTypeSchema | INumberContentTypeSchema | IBooleanContentTypeSchema | IDateContentTypeSchema | IFileContentTypeSchema | ILinkContentTypeSchema | IModularBlocksContentTypeSchema | IGroupContentTypeSchema | IReferenceContentTypeSchema | IGlobalFieldContentTypeSchema | IExperienceContainerContentTypeSchema | ITitleContentTypeSchema | IURLContentTypeSchema | ITaxanonmyContentTypeSchema;
export interface IModularBlockSingleBlock {
    title: string;
    uid: string;
    schema: IContentTypeCommonBlocks[];
}
export interface IModularBlocksContentTypeSchema extends IContentTypeSchemaCommonData {
    data_type: "blocks";
...
export interface IGlobalFieldContentTypeSchema extends IContentTypeSchemaCommonData {
...
export {};
//# sourceMappingURL=contentTypeSchema.types.d.ts.map