...
export { adjustPositionToViewport, filterOutInvalidMentions, fixSvgXPath, getCommentBody, getMessageWithDisplayName, getThreadTitle, getUserName, normalizePath, sanitizeData, validateCommentAndMentions };
