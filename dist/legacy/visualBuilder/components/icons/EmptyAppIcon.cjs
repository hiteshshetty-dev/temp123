...
// src/visualBuilder/components/icons/EmptyAppIcon.tsx
var EmptyAppIcon_exports = {};
__export(EmptyAppIcon_exports, {
  EmptyAppIcon: () => EmptyAppIcon,
  getColorFromString: () => getColorFromString,
  sumOfAscii: () => sumOfAscii
});
module.exports = __toCommonJS(EmptyAppIcon_exports);
...
var EmptyAppIcon = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "36", cy: "36", r: "36", fill: getColorFromString(id) }),
...
var sumOfAscii = (str) => [...str].reduce((a, b) => a + b.charCodeAt(0), 0);
...
//# sourceMappingURL=EmptyAppIcon.cjs.map