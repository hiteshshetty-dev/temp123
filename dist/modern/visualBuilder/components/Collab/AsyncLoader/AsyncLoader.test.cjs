...
var import_dom2 = require("@testing-library/dom.cjs");
var import_preact2 = require("preact");
var import_hooks = require("preact/hooks");
var import_test_utils = require("preact/test-utils");

// node_modules/@testing-library/preact/dist/esm/fire-event.mjs
var import_dom = require("@testing-library/dom.cjs");
var import_preact = require("preact");
var isCompat = false;
var oldHook = import_preact.options.vnode;
import_preact.options.vnode = (vnode) => {
...
var fireEvent = (...args) => (0, import_dom.fireEvent)(...args);
Object.keys(import_dom.fireEvent).forEach((key) => {
  fireEvent[key] = (elem, init) => {
    ...
    return isInElem ? import_dom.fireEvent[keyFiltered](elem, init) : (0, import_dom.fireEvent)(elem, (0, import_dom.createEvent)(keyFiltered[0].toUpperCase() + keyFiltered.slice(1), elem, init));
  };
});

// node_modules/@testing-library/preact/dist/esm/pure.mjs
__reExport(pure_exports, require("@testing-library/dom.cjs"));
(0, import_dom2.configure)({
...
function render(ui, {
  ...
  const wrapUiIfNeeded = (innerElement) => WrapperComponent ? (0, import_preact2.h)(WrapperComponent, null, innerElement) : innerElement;
  (0, import_test_utils.act)(() => {
    if (hydrate) {
      (0, import_preact2.hydrate)(wrapUiIfNeeded(ui), container);
    } else {
      (0, import_preact2.render)(wrapUiIfNeeded(ui), container);
    }
  });
  return {
    container,
    baseElement,
    debug: (el = baseElement, maxLength, options2) => Array.isArray(el) ? el.forEach((e) => console.log((0, import_dom2.prettyDOM)(e, maxLength, options2))) : console.log((0, import_dom2.prettyDOM)(el, maxLength, options2)),
    unmount: () => (0, import_preact2.render)(null, container),
    rerender: (rerenderUi) => {
      (0, import_test_utils.act)(() => {
      });
    ...
    ...(0, import_dom2.getQueriesForElement)(baseElement, queries)
  };
}
...
function renderHook(renderCallback, options2) {
  ...
  const result = (0, import_preact2.createRef)();
  ...
  const {
    ...
    unmount
  } = render((0, import_preact2.h)(TestComponent, {
    renderCallbackProps: initialProps
  }), {
    wrapper
  });
  function rerender(rerenderCallbackProps) {
    return baseRerender((0, import_preact2.h)(TestComponent, {
...
var import_redent = __toESM(require("redent.cjs"), 1);
var import_css_tools = require("@adobe/css-tools.cjs");
var import_dom_accessibility_api = require("dom-accessibility-api.cjs");
var import_aria_query = require("aria-query.cjs");
var import_chalk = __toESM(require("chalk.cjs"), 1);
var import_isEqualWith = __toESM(require_isEqualWith(), 1);
var import_css = __toESM(require("css.escape.cjs"), 1);
...
function parseCSS(css, ...args) {
  const ast = (0, import_css_tools.parse)(`selector { ${css} }`, { silent: true }).stylesheet;
...
function toHaveAccessibleDescription(htmlElement, expectedAccessibleDescription) {
  ...
  const actualAccessibleDescription = (0, import_dom_accessibility_api.computeAccessibleDescription)(htmlElement);
...
function toHaveAccessibleName(htmlElement, expectedAccessibleName) {
  ...
  const actualAccessibleName = (0, import_dom_accessibility_api.computeAccessibleName)(htmlElement);
  const missingExpectedValue = arguments.length === 1;
  let pass = false;
  if (missingExpectedValue) {
...
var import_redent2 = require("redent.cjs");
var import_css_tools2 = require("@adobe/css-tools.cjs");
var import_dom_accessibility_api2 = require("dom-accessibility-api.cjs");
var import_aria_query2 = require("aria-query.cjs");
var import_chalk2 = require("chalk.cjs");
var import_isEqualWith2 = __toESM(require_isEqualWith(), 1);
var import_css2 = require("css.escape.cjs");
expect.extend(extensions);

// src/visualBuilder/components/Collab/AsyncLoader/AsyncLoader.test.tsx
var import_AsyncLoader = __toESM(require("./AsyncLoader.cjs"), 1);
var import_jsx_runtime = require("preact/jsx-runtime");
describe("AsyncLoader", () => {
  it("renders with default primary color when no color is provided", () => {
    const { container } = render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { testId: "test" }));
    expect(
  ...
  it("renders with secondary color when specified", () => {
    const { container } = render(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { color: "secondary", testId: "test" })
    );
    expect(
  ...
  it("renders with tertiary color when specified", () => {
    const { container } = render(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { color: "tertiary", testId: "test" })
    );
    expect(
  ...
  it("renders with destructive color when specified", () => {
    const { container } = render(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { color: "destructive", testId: "test" })
    );
    expect(
  ...
  it("applies custom className when provided", () => {
    const { container } = render(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { className: "custom-class", testId: "test" })
    );
  ...
  it("uses default testId when none is provided", () => {
    render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, {}));
  ...
  it("spreads additional props to the wrapper div", () => {
    render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { "data-foo": "bar", "aria-label": "Loading" }));
  ...
  it("renders all three loader dots with correct classes", () => {
    const { container } = render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, {}));
  ...
  it("combines custom class with color variant", () => {
    const { container } = render(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { className: "custom-class", color: "destructive" })
    );
  ...
  it("maintains accessibility attributes", () => {
    render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_AsyncLoader.default, { "aria-label": "Loading content" }));
    const loader = esm_exports.screen.getByTestId("collab-async-loader");
    expect(loader).toHaveAttribute("aria-label", "Loading content");
  });
});
//# sourceMappingURL=AsyncLoader.test.cjs.map